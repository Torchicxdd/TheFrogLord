...
var round1_enemy_setup: Array[EnemySetup] = [
	EnemySetup.new(PreloadedEnemies.dosha.instantiate(), Vector2i(3, 2))
]
var round2_enemy_setup: Array[EnemySetup] = [
	EnemySetup.new(PreloadedEnemies.dosha.instantiate(), Vector2i(3, 1)),
	EnemySetup.new(PreloadedEnemies.dosha.instantiate(), Vector2i(3, 0))
]
var round3_enemy_setup: Array[EnemySetup] = [
	EnemySetup.new(PreloadedEnemies.dosha.instantiate(), Vector2i(3, 3))
]
